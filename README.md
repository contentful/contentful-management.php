...
This repo ships [Golden Context](./AGENTS.md) documentation to help both humans and AI tools work safely.

| Document | What it covers |
|---|---|
| [AGENTS.md](./AGENTS.md) | Sharp edges, invariants, quick-reference map — **read this first** |
| [ARCHITECTURE.md](./ARCHITECTURE.md) | Internal structure, data flow, dependency rationale |
| [CONTRIBUTING.md](./CONTRIBUTING.md) | Dev setup, commands, testing, CI, release process |
