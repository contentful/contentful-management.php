...
class Client extends BaseClient
{
     ...
     */
    public function __construct(string $accessToken, string $currentSpaceId = null, array $options = [])
    {
        parent::__construct(
            $accessToken,
    ...
    public function getProxy(string $name, string $spaceId = null): BaseProxy
    {
        ...
        $class = __NAMESPACE__.'\\Proxy\\'.self::$proxyMap[$normalizedName];
