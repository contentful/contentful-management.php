 ...
 * BaseProxy class.
 *
 * @method ResourceInterface create(Creatable $resource, string $resourceId = null)
 * @method ResourceInterface update(Updatable $resource)
 * @method ResourceInterface delete(ResourceInterface|string $resource, int $version = null)
 * @method ResourceInterface archive(ResourceInterface|string $resource, int $version = null)
 * @method ResourceInterface unarchive(ResourceInterface|string $resource, int $version = null)
 * @method ResourceInterface publish(ResourceInterface|string $resource, int $version = null)
 * @method ResourceInterface publish(ResourceInterface|string $resource, int $version = null)
 */
