 ...
 * Webhook class.
 *
 * @method ResourceInterface create(\Contentful\Management\Resource\Webhook $resource, string $resourceId = null)
 * @method ResourceInterface update(\Contentful\Management\Resource\Webhook $resource)
 * @method ResourceInterface delete(\Contentful\Management\Resource\Webhook|string $resource, int $version = null)
 */
